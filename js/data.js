...
const infoList = [
  {
    ...
    mLeft: '20%',
    name: '거북이',
    desc: '안전지향적인 성향을 지닌 거북이입니다.' + '<br>' + '자산배분: 주식 20%, 채권 80%로 보수적인 포트폴리오'
  },
  {
    from: 11,
    to: 49,
    mLeft: '40%',
    name: '미어캣',
    desc: '안정을 추구하는 성향을 지닌 미어캣입니다.' + '<br>' + '자산배분: 주식 40%, 채권 60%로 안정적인 포트폴리오'
  },
  {
    from: 50,
    to: 89,
    mLeft: '60%',
    name: '하이에나',
    desc: '적극적인 성향을 지닌 하이에나입니다.' + '<br>' + '자산배분: 주식 60%, 채권 40%로 기본적인 포트폴리오'
  },
  {
    from: 90,
    to: 100,
    mLeft: '80%',
    name: '사자',
    desc: '공격적인 성향을 지닌 사자입니다.' + '<br>' + '자산배분: 주식 80%, 채권 20%로 공격적인 포트폴리오'
  }
]
...
const infoList4 = [
  ...
  },
  {
    ...
    to: 2,
    name: '당신은... 뒷산의 ',
    desc: '당신은 뒷산에 서식하며 때로는 풍족하게 먹이를 먹지만 때로는 굶어야 할 때도 있으며, '
  },
  {
    from: 3,
    to: 3, 
    name: '당신은... 사바나의 ',
    desc: '당신은 사바나에 서식하며 왕으로 군림할 수도 잡아먹힐 수도 있으며, '
  }
]
