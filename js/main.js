...
const goResult = () => {
  ...
  pTitle.innerHTML = u_name.value + ' 님의 자산 포트폴리오 분석';
  ...
  desc.innerHTML = infoList[grade].desc + "<br>" + "<br>" + infoList5[grade5_2].desc + "<br>" + "<br>" + infoList2[grade2_2].desc + "<br>" + "<br>" + infoList4[grade4_2].desc + "<br>" + "<br>" + "<br>" + "<span style='color:red;'><strong>구성자산</strong><br><br>※ 아래 자산을 클릭하면 관련 정보를 자세히 알 수 있습니다.</span>" + "<br>" + "<br>" + "<a href='" + infoList3[grade3_2].link + "' target='_blank' ><span style='color:red'>-&gt;</span>" + infoList3[grade3_2].desc2 + "<span style='color:red'>&lt;-</span></a>" + "<br>" + "<a href='" + infoList2[grade2_2].link + "' target='_blank' ><span style='color:red'>-&gt;</span>" + infoList2[grade2_2].desc2 + "<span style='color:red'>&lt;-</span></a>"+ "<br>" + "<a href='" + infoList4[grade4_2].link + "' target='_blank' ><span style='color:red'>-&gt;</span>" + infoList4[grade4_2].desc2 + "<span style='color:red'>&lt;-</span></a>" + "<br>" + "<br>" + "아직 수정 중인 베타 버전입니다.<br>이용 후기 및 개선사항을 알려주시면,<br>추첨을 통해 선물을 드릴 예정입니다." + "<br>" + "<br>" + "<a href='https://docs.google.com/forms/d/e/1FAIpQLSf0W1tIlUFk0-IngEx629bqrS6HeYbhccwSCq1fnnnl6hlV9w/viewform?usp=sf_link'" + "' target='_blank' ><span style='color:red'>-&gt;</span>" + "<이벤트 참여하기>" + "를 클릭해주세요." + "<span style='color:red'>&lt;-</span></a>";
