...
const goResult = () => {
  ...
  hyungu.innerHTML = infoList[grade].name2 + infoList5[grade5_2].name2 + infoList2[grade2_2].name2 + infoList4[grade4_2].name2 + infoList[grade].name3 + infoList5[grade5_2].name3 + infoList2[grade2_2].name3 + infoList4[grade4_2].name3; 
