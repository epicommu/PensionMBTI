...
const goResult = () => {
  ...
  desc.innerHTML = infoList4[grade4_2].desc + "<br>" + infoList[grade].desc + "<br>" + infoList3[grade3_2].desc + "<br>" + infoList2[grade2_2].desc + "<br>" + "<br>" + "추천자산" + "<br>" + "<a href='" + infoList4[grade3_2].link + "'>" + infoList3[grade3_2].desc2 + "<br>" + "<a href='" + infoList4[grade2_2].link + "'>" + infoList2[grade2_2].desc2 + "<br>" + "<a href='" + infoList4[grade4_2].link + "'>" + infoList4[grade4_2].desc2;
